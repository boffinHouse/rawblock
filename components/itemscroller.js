(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../core', '../utils/css-supports', '../utils/resize', '../utils/prefixed', '../utils/draggy_wheel'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../core'), require('../utils/css-supports'), require('../utils/resize'), require('../utils/prefixed'), require('../utils/draggy_wheel'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.core, global.cssSupports, global.resize, global.prefixed, global.draggy_wheel);
        global.itemscroller = mod.exports;
    }
})(this, function (exports, _core, _cssSupports) {
    'use strict';
    ...
    var orderProp = _core2.default.prefixed('order') || _core2.default.prefixed('flexOrder');
    var supportSomeOrder = !!orderProp;
    var transformProp = _core2.default.prefixed('transform');
    ...
    var ItemScroller = function (_Component) {
        _inherits(ItemScroller, _Component);
        ...
        function ItemScroller(element, initialDefaults) {
            ...
            _this.throttledCalculateLayout = _core2.default.throttle(_this.calculateLayout);
            _this.reflow = _this.throttledCalculateLayout;

            _this.setPos = _core2.default.rAF(_this._setPos, { that: _this, throttle: true });

            _core2.default.rAFs(_this, { throttle: true }, '_writeLayout', '_createPagination', '_switchOff', 'setSwitchedOffClass', '_updateControls');
            ...
            switch (name) {
                ...
                case 'carousel':
                    ...
                    if (name == 'carousel' && value) {
                        this.$queryAll('.{name}{e}btn{-}next, .{name}{e}btn{-}prev').prop({ disabled: false }).removeClass(_core2.default.statePrefix + 'disabled');
                    }
                    break;
                case 'easing':
                    this._easing = _core2.default.addEasing(value);
                    this.easing = this._easing;
                    break;
                case 'dragEasing':
                    this._dragEasing = _core2.default.addEasing(value);
                    break;
                case 'duration':
                    this.duration = value;
        ...
        ItemScroller.prototype._generateHelper = function _generateHelper() {
            ...
            this.helperElem = $(document.createElement('div')).attr({
                'class': 'js' + _core2.default.nameSeparator + this.name + _core2.default.elementSeparator + 'helper',
        ...
        ItemScroller.prototype._setupFocusScroll = function _setupFocusScroll() {
            var that = this;
            var cellSel = '.' + this.name + _core2.default.elementSeparator + 'cell';
            var isTestStopped = false;
            var keyboardFocusClass = _core2.default.utilPrefix + 'keyboardfocus' + _core2.default.nameSeparator + 'within';
            ...
            var scrollIntoView = function scrollIntoView(e) {
                ...
                if (!isTestStopped) {
                    ...
                    if (focusedElement && focusedElement.closest && _core2.default.root.classList.contains(keyboardFocusClass) && (cell = focusedElement.closest(cellSel)) && that.isCellVisible(cell) !== true) {
        ...
        ItemScroller.prototype._slideComplete = function _slideComplete() {
            ...
            var activeDone = _core2.default.statePrefix + 'active' + _core2.default.nameSeparator + 'done';
            ...
            if (curPage) {
                (curPage.$cellElems || (curPage.$cellElems = $(curPage.cellElems))).addClass(activeDone).addClass(_core2.default.statePrefix + 'activated' + _core2.default.nameSeparator + 'done');
            }
        ...
        ItemScroller.prototype._updateControls = function _updateControls(pos) {
            ...
            this.$cells.removeClass(_core2.default.statePrefix + 'active');
            if (curPage) {
                (curPage.$cellElems || (curPage.$cellElems = $(curPage.cellElems))).addClass(_core2.default.statePrefix + 'activated').addClass(_core2.default.statePrefix + 'active');
            }

            this.$paginationBtns.removeClass(_core2.default.statePrefix + 'selected').eq(this._selectedIndex).addClass(_core2.default.statePrefix + 'selected');
        };
        ...
        ItemScroller.prototype.updateCells = function updateCells() {
            var that = this;
            var cellSelector = ':not(.js' + _core2.default.nameSeparator + this.name + _core2.default.elementSeparator + 'helper)';
            ...
            if (this.options.excludeHiddenCells) {
                this.$cells = this.$cells.filter(function () {
                    return _core2.default.getStyles(this).display != 'none';
                });
            }
            ...
            _core2.default.rAFQueue(function () {
                ...
                that.$cells.addClass(that.name + _core2.default.elementSeparator + 'cell');
            });
        };
        ...
        ItemScroller.prototype._calculateCellLayout = function _calculateCellLayout() {
            ...
            this.cellData = this.$cells.map(function () {
                ...
                lastWidth = returnWidth + width + _core2.default.getCSSNumbers(this, ['margin-left', 'margin-right']);
        ...
        ItemScroller.prototype._adjustSelectedIndex = function _adjustSelectedIndex() {
            var active = this.$cells.filter('.' + _core2.default.statePrefix + 'active').get(0);
        ...
        ItemScroller.prototype._createPagination = function _createPagination() {
            ...
            if (this.$pagination.length && this.$paginationBtns.length != baseLength) {
                ...
                this.$paginationBtns = this.$pagination.find('.' + this.name + _core2.default.elementSeparator + 'pagination' + _core2.default.nameSeparator + 'btn');
                this.$paginationBtns.eq(this._selectedIndex).addClass(_core2.default.statePrefix + 'selected');
            }
        };
    ...
    _core.Component.register('itemscroller', ItemScroller);
