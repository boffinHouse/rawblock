(function (global, factory) {
    ...
    var docElem = _core2.default.root;
    ...
    var Scrolly = function (_ref) {
        ...
        function Scrolly(element, initialDefaults) {
            ...
            _core2.default.rAFs(_this, { throttle: true }, 'changeState', 'setSwitchedOffClass', 'updateScrollFixedElement', 'changePrepareState');

            _core2.default.rAFs(_this.onprogress, 'fireWith');
        ...
        Scrolly.prototype._setupThrottleDelay = function _setupThrottleDelay(delay) {
            if (delay && delay > 30) {
                this.throtteldCheckPosition = _core2.default.throttle(this.checkPosition, { delay: delay });
            } else {
        ...
        Scrolly.prototype.checkPosition = function checkPosition() {
            ...
            if (Date.now() - this.lastCheck > this.checkTime) {
                this.lastCheck = Date.now();
                _core2.default.rIC(this.calculateLayout);
            }
        ...
        Scrolly.prototype.updateScrollFixedElement = function updateScrollFixedElement(isEntered) {
            ...
            if (this.enteredFixed != isEntered) {
                this.scrollFixedElement.classList.toggle(_core2.default.statePrefix + 'fixed-entered', isEntered);
                if (isEntered) {
        ...
        Scrolly.prototype.changePrepareState = function changePrepareState() {
            this.element.classList.toggle(_core2.default.statePrefix + 'scrollrange' + _core2.default.nameSeparator + 'prepared', this.prepareEntered);
        };
        ...
        Scrolly.prototype.changeState = function changeState(shouldEnter) {
            ...
            if (this.entered != shouldEnter) {
                ...
                this.element.classList[shouldEnter ? 'add' : 'remove'](_core2.default.statePrefix + 'in' + _core2.default.nameSeparator + 'scrollrange');
        ...
        Scrolly.prototype._setScrollinElement = function _setScrollinElement() {
            ...
            if (!this.scrollingElement || !this.options.scrollContainer) {
                this.scrollingElement = _core2.default.getPageScrollingElement();
            }
    ...
    _core.Component.register('scrolly', Scrolly);
