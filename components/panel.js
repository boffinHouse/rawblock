(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../core', './panelbutton', './_focus-component', '../utils/$_slide-up-down', '../utils/contains'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../core'), require('./panelbutton'), require('./_focus-component'), require('../utils/$_slide-up-down'), require('../utils/contains'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.core, global.panelbutton, global._focusComponent, global.$_slideUpDown, global.contains);
    ...
    var Panel = function (_rb$components$_focus) {
        ...
        function Panel(element, initialDefaults) {
            ...
            _this.isOpen = _this.element.classList.contains(_core2.default.statePrefix + 'open');
            ...
            _core2.default.rAFs(_this, { throttle: true }, '_opened', '_closed', '_switchOn', '_switchOff');
            _core2.default.rAFs(_this, { throttle: true, that: _this }, '_setDisplay');
            ...
            if (!_this.options.switchedOff) {
                ...
                _core2.default.rAFQueue(function () {
                    element.classList.add(_core2.default.statePrefix + 'switched' + _core2.default.nameSeparator + 'off');
                });
            }
            return _this;
        }
        ...
        Panel.prototype._switchOff = function _switchOff() {
            ...
            if (!this.isDefaultOpen) {
                this.element.classList.remove(_core2.default.statePrefix + 'open');
            }

            this.element.classList.add(_core2.default.statePrefix + 'switched' + _core2.default.nameSeparator + 'off');
        ...
        Panel.prototype._switchOn = function _switchOn() {
            if (this.isOpen) {
                this.element.classList.add(_core2.default.statePrefix + 'open');
            }

            this.element.classList.remove(_core2.default.statePrefix + 'switched' + _core2.default.nameSeparator + 'off');
        ...
        Panel.prototype._shouldTeardown = function _shouldTeardown() {
            if (!this.isOpen && !this.options.closeOnOutsideClick && this.options.closeOnFocusout || !_core2.default.root.contains(this.element)) {
        ...
        Panel.prototype._onBodyClick = function _onBodyClick(e) {
            var that;
            if (this.options.closeOnOutsideClick && !this._shouldTeardown() && document.body.contains(e.target) && !_core2.default.contains(this.element, e.target)) {
                that = this;
        ...
        Panel.prototype._onOutSideAction = function _onOutSideAction(e) {
            ...
            if (this.options.closeOnFocusout && (e.type != 'focus' || e.target.tabIndex != -1) && document.body.contains(e.target) && !this._shouldTeardown()) {
                ...
                if (!_core2.default.contains(containers, e.target)) {
                    this.close();
                }
            }
        };
        ...
        Panel.prototype._scroll = function _scroll(relPos, animationData) {
            ...
            if (relPos) {
                scrollingElement = _core2.default.getPageScrollingElement();
        ...
        Panel.prototype.scrollIntoView = function scrollIntoView(opts) {
            ...
            viewHeight = _core2.default.root.clientHeight;
    ...
    _core.Component.register('panel', Panel);
