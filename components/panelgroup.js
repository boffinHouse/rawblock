(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../core', './panelbutton', './panel', './_composer-component', '../utils/contains'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../core'), require('./panelbutton'), require('./panel'), require('./_composer-component'), require('../utils/contains'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.core, global.panelbutton, global.panel, global._composerComponent, global.contains);
    ...
    var $ = _core.Component.$;
    var live = _core2.default.live;
    var componentExpando = live.componentExpando;
    var components = _core2.default.components;
    ...
    var PanelGroup = function (_rb$components$_compo) {
        _inherits(PanelGroup, _rb$components$_compo);
        ...
        function PanelGroup(element, initialDefaults) {
            ...
            var _this = _possibleConstructorReturn(this, _rb$components$_compo.call(this, element, initialDefaults));
            ...
            _core2.default.rAFs(_this, 'setSelectedState', 'setSwitchedOffClass');
        ...
        PanelGroup.prototype.setSwitchedOffClass = function setSwitchedOffClass() {
            this.element.classList[this.options.switchedOff ? 'add' : 'remove'](_core2.default.statePrefix + 'switched' + _core2.default.nameSeparator + 'off');
        };
        ...
        PanelGroup.prototype.animateWrapper = function animateWrapper(openedPanel) {
            ...
            $(closingPanels).addClass(_core2.default.statePrefix + 'closing');
            ...
            this.$panelWrapper.attr({ 'data-direction': nextIndex > curIndex ? 'up' : 'down' }).css({
                ...
                always: function always() {
                    that.$panels.removeClass(_core2.default.statePrefix + 'closing');
                    that.$panelWrapper.removeClass(_core2.default.statePrefix + 'fx').attr({ 'data-direction': '' });
                    cleanupCSS.call(this);
                }
            }).addClass(_core2.default.statePrefix + 'fx');
        };

        PanelGroup.prototype.setSelectedState = function setSelectedState() {
            this.element.classList.toggle(_core2.default.statePrefix + 'selected' + _core2.default.nameSeparator + 'within', !!this.selectedIndexes.length);
        };
        ...
        PanelGroup.prototype._onOutSideInteraction = function _onOutSideInteraction(e) {
            ...
            if (target && (e.type != 'focus' || target.tabIndex != -1) && !_core2.default.contains(this.element, target) && document.body.contains(target)) {
                this.closeAll();
            }
        };
        ...
        PanelGroup.prototype._getElements = function _getElements() {
            ...
            this.createChildComponents('panel', this.$panels.get(), [{
                name: 'itemWrapper',
                computeValue: function computeValue(value, name, component) {
                    return component.interpolateName(value || '');
                }
            }, 'resetSwitchedOff', 'setFocus', 'closeOnEsc', 'adjustScroll', 'scrollIntoView', 'setDisplay', 'autofocusSel', 'switchedOff']).forEach(function (panel) {
            ...
            }, 'preventDefault', 'switchedOff']).forEach(function (btn, index) {
        ...
        PanelGroup.prototype.setOption = function setOption(name, value, isSticky) {
            ...
            if (name == 'multiple' && value && !this.options.toggle) {
                ...
                _core2.default.addEasing(value);
        ...
        return PanelGroup;
    }(_core2.default.components._composer_component);

    _core.Component.register('panelgroup', PanelGroup);
    ...
    _core.Component.register('panelgroupbutton', PanelGroupButton);
    ...
    _core.Component.register('tabs', Tabs);
    ...
    _core.Component.register('accordion', Accordion);
});
