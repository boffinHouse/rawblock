(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../core', '../utils/spring-animation'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../core'), require('../utils/spring-animation'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.core, global.springAnimation);
    ...
    var SpringAnimationDemoGroup = function (_Component) {
        _inherits(SpringAnimationDemoGroup, _Component);
        ...
        function SpringAnimationDemoGroup(element, initialDefaults) {
            ...
            _this.templates = Object.assign({}, _this.templates, {
                childTemplate: _core2.default.template(_this.query('.{name}-child-template').innerHTML)
            });
            ...
            _this.onChildDemoEnded = _core2.default.debounce(_this.onChildDemoEnded, { delay: 100 });
        ...
        SpringAnimationDemoGroup.prototype.getChildComponents = function getChildComponents() {
            return this.childCompontents = this.queryAll('[data-module="springanimationdemo"]').map(function (element) {
                return _core2.default.getComponent(element);
            });
        };
    ...
    var SpringAnimationDemo = function (_rb$Component) {
        ...
        function SpringAnimationDemo(element, initialDefaults) {
            ...
            var _this4 = _possibleConstructorReturn(this, _rb$Component.call(this, element, initialDefaults));
        ...
        SpringAnimationDemo.prototype.createSpring = function createSpring(wasAtEnd, opts) {
            ...
            this.springAnimation = new _core2.default.SpringAnimation(springOpts);
    ...
    }(_core2.default.Component);

    _core.Component.register('springanimationdemogroup', SpringAnimationDemoGroup);

    exports.SpringAnimationDemoGroup = SpringAnimationDemoGroup;
    exports.SpringAnimationDemo = SpringAnimationDemo;
    exports.default = _core.Component.register('springanimationdemo', SpringAnimationDemo);
});
