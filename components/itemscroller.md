...
<div class="docs-example is-demo">
    {{#mergeJSON itemscroller.default }}
        {{> itemscroller }}
    {{/mergeJSON}}
</div>
...
<div class="docs-example">
    {{#mergeJSON itemscroller.default 'pagination: true, attrs: {"data-itemscroller-mandatory-snap":true, "data-itemscroller-mandatory-snap-wheel":true}' }}
        {{> itemscroller }}
    {{/mergeJSON}}
</div>
...
<h3 class="docs-example-title">Demo</h3>
<div class="docs-example">
	{{#mergeJSON itemscroller.default 'pagination: true, attrs: {"data-itemscroller-center-mode":true}'}}
		{{> itemscroller }}
	{{/mergeJSON}}
</div>
...
<h3 class="docs-example-title">Demo</h3>
<div class="docs-example">
    {{#mergeJSON itemscroller.default 'attrs: {"data-itemscroller-carousel":true}'}}
        {{> itemscroller }}
    {{/mergeJSON}}
</div>
...
<h3 class="docs-example-title">Demo</h3>
<div class="docs-example">
    {{#mergeJSON itemscroller.default 'itemsIndex: true'}}
        {{> itemscroller }}
    {{/mergeJSON}}
</div>
...
<div class="docs-example">
    <div class="u-gutters-vertical">
        <div class="u-size-100">
            {{#mergeJSON itemscroller.default 'attrs: {"id":"itemscroller-pagination"}'}}
                {{> itemscroller }}
            {{/mergeJSON}}
        </div>
        <div class="u-size-100">
            {{#mergeJSON itemscroller.default 'attrs: {"data-itemscroller-pagination-for":"itemscroller-pagination"}'}}
                {{> itemscroller }}
            {{/mergeJSON}}
        </div>
    </div>
