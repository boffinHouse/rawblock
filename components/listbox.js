(function (global, factory) {
    ...
    var Listbox = function (_Component) {
        ...
        function Listbox(element, initialDefaults) {
            ...
            _this.rAFs({ throttle: true }, '_changeSelected', '_changeChecked', 'postRender', 'renderList', '_setFocusElement', '_setInitialMarkup');
        ...
        Listbox.prototype._setInitialMarkup = function _setInitialMarkup() {
            ...
            this.$items.filter('.' + _core2.default.statePrefix + 'disabled').attr({ 'aria-disabled': 'true' });
        ...
        Listbox.prototype._getElements = function _getElements() {
            ...
            this.checkedItem = this.$items.filter('.' + _core2.default.statePrefix + 'checked').get(0) || null;
        ...
        Listbox.prototype._changeSelected = function _changeSelected() {
            this.$items.removeClass(_core2.default.statePrefix + 'selected');

            if (this.selectedItem) {
                this.selectedItem.classList.add(_core2.default.statePrefix + 'selected');
        ...
        Listbox.prototype.getSelectableIndex = function getSelectableIndex(dir) {
            var item;
            var ret = -1;
            var disabledClass = _core2.default.statePrefix + 'disabled';
        ...
        Listbox.prototype._changeChecked = function _changeChecked() {
            this.$items.filter('.' + _core2.default.statePrefix + 'checked').rbToggleState('checked', false).removeAttr('aria-checked');

            if (this.checkedItem) {
                this.checkedItem.classList.add(_core2.default.statePrefix + 'checked');
                this.checkedItem.setAttribute('aria-checked', 'true');
            }
            this.trigger();
        };
    ...
    _core.Component.register('listbox', Listbox);
