(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './utils/global-rb', './utils/deferred', './utils/request-idle-callback', './utils/rafqueue', './utils/throttle', './utils/get-id', './utils/add-log', './utils/get-css-numbers', './crucial', './utils/rafs', './utils/debughelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./utils/global-rb'), require('./utils/deferred'), require('./utils/request-idle-callback'), require('./utils/rafqueue'), require('./utils/throttle'), require('./utils/get-id'), require('./utils/add-log'), require('./utils/get-css-numbers'), require('./crucial'), require('./utils/rafs'), require('./utils/debughelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.globalRb, global.deferred, global.requestIdleCallback, global.rafqueue, global.throttle, global.getId, global.addLog, global.getCssNumbers, global.crucial, global.rafs, global.debughelpers);
    ...
    var Component = exports.Component = _globalRb2.default.Component;
