describe('router', function () {
    ...
    it('applies routes', function(){
        ...
        expect(user).toHaveBeenCalledWith({}, {}, {fragment: 'user', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
        ...
        expect(userId).toHaveBeenCalledWith({id: 'theId'}, {}, {fragment: 'user/theId', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
        ...
        expect(userEditItem).toHaveBeenCalledWith({id: 'theUserId-1', itemdId: 'theItemId-1'}, {}, {fragment: 'user/theUserId-1/editItem/theItemId-1', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
    ...
    it('handles nested routes', function(){
        ...
        expect(routes['/:lang'].handler).toHaveBeenCalledWith({lang: 'en'}, {}, {fragment: 'en', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
        expect(routes['/:lang'].subRoutes['/'].handler).toHaveBeenCalledWith({lang: 'en'}, {}, {fragment: 'en', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
        ...
        expect(routes['/:lang'].subRoutes['products/:id/edit/'].handler).toHaveBeenCalledWith({lang: 'en', id: '12'}, {}, {fragment: 'en/products/12/edit', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
        expect(routes['/:lang'].handler).toHaveBeenCalledWith({lang: 'en', '*': 'products/12/edit'}, {}, {fragment: 'en/products/12/edit', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
        ...
        expect(routes['/:lang'].subRoutes['products/:id/edit/'].handler).toHaveBeenCalledWith({lang: 'en', id: '12'}, {foo: 'bar'}, {fragment: 'en/products/12/edit', changedRoute: false, changedOptions: true, event: { type: 'unknown/initial'}});
        ...
        expect(routes['/:lang'].handler).toHaveBeenCalledWith({lang: 'unknownLanguage', '*': 'products'}, {}, {fragment: 'unknownLanguage/products', changedRoute: true, changedOptions: false, event: { type: 'unknown/initial'}});
