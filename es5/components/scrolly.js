    ...
    (function (factory) {
        ...
        /** @lends rb.components.scrolly.prototype */
        {
            ...
            *     }
            ...
            _setupThrottleDelay: function _setupThrottleDelay(delay) {
                if (delay && delay > 30) {
            ...
            updateScrollFixedElement: function updateScrollFixedElement(isEntered) {
            ...
            _setScrollinElement: function _setScrollinElement() {
