(function (global, factory) {
    ...
    (function (factory) {
        ...
        /** @lends rb.components.listbox.prototype */
        {
            ...
            _setInitialMarkup: function _setInitialMarkup() {
            ...
            _onkeyboardInput: function _onkeyboardInput(e) {
                var prevent;
            ...
            setFocusElement: function setFocusElement() {
                ...
                this.focusElement = (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) == 'object' ? value : value && this.getElementsFromString(value)[0] || this.element;
            ...
            _setFocusElement: function _setFocusElement(old) {
                if (old) {
            ...
            _selectCheck: function _selectCheck(index, type) {
                var item;
            ...
            scrollIntoView: function scrollIntoView(item, noAnimate) {
            ...
            _changeSelected: function _changeSelected() {
            ...
            getSelectableIndex: function getSelectableIndex(dir) {
                var item;
                var ret = -1;
            ...
            _changeChecked: function _changeChecked() {
