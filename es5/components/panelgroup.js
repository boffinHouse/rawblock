(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'babel-runtime/helpers/typeof', './panel'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('babel-runtime/helpers/typeof'), require('./panel'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global._typeof, global.panel);
    ...
    (function (factory) {
        ...
        /** @lends rb.components.panelgroup.prototype */
        {
            ...
            * });
            ...
            _handleAnimation: function _handleAnimation(animationData) {
            ...
            animateWrapper: function animateWrapper(openedPanel) {
                var end;
            ...
            _addRemoveFocusOut: function _addRemoveFocusOut() {
            ...
            _onOutSideInteraction: function _onOutSideInteraction(e) {
             ...
             * @param {Element|ComponentInstance|Number} [except]
             */
            openAll: function openAll(except) {
                this.$panels.get().forEach(function (panel, i) {
                    var component = live.getComponent(panel);
                    if (component && component != except && panel != except && i !== except) {
                        component.open();
            ...
            _triggerOnce: function _triggerOnce() {
                var that;
            ...
            panelChangeCB: function panelChangeCB(panelComponent, action) {
                var options = this.options;
            ...
            getComponentByIndexOrDOM: function getComponentByIndexOrDOM(index) {
                var panel;
                if (index == null) {
                    index = 0;
                }

                panel = typeof index == 'number' ? this.$panels.get(index) : index;
             ...
             * @returns {Boolean}
             */
            selectIndex: function selectIndex(index, options) {
             ...
             * @returns {Boolean}
             */
            deselectIndex: function deselectIndex(index, options) {
                var component = this.getComponentByIndexOrDOM(index);
