(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'babel-runtime/helpers/typeof', './panel', '../utils/rb_position'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('babel-runtime/helpers/typeof'), require('./panel'), require('../utils/rb_position'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global._typeof, global.panel, global.rb_position);
    ...
    (function (factory) {
        ...
        /** @lends rb.components.popover.prototype */
        {
            ...
            initPositionedElement: function initPositionedElement() {
                var that = this;
            ...
            scrollRepostion: function scrollRepostion(e) {
                if (!rb.root.contains(this.element)) {
                    this.teardownPopoverResize();
                    return;
                }
            ...
            connect: function connect(isOpening, options) {
