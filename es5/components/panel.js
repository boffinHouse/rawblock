    ...
    (function (factory) {
        ...
        /** @lends rb.components.panel.prototype */
        {
            ...
            * });
            ...
            _setDisplay: function _setDisplay() {
                if (!this.isOpen) {
            ...
            _shouldTeardown: function _shouldTeardown() {
            ...
            _onBodyClick: function _onBodyClick(e) {
                var that;
            ...
            _onOutSideAction: function _onOutSideAction(e) {
            ...
            setupOnOpenEvts: function setupOnOpenEvts() {
                this.teardownOnOpenEvts();
            ...
            teardownOnOpenEvts: function teardownOnOpenEvts() {
            ...
            _handleAnimation: function _handleAnimation(e) {
                var $panel;
                var panel = this;
                var animationData = {};
            ...
            _getFocusDelay: function _getFocusDelay(actionOptions) {
                var mainOpts = this.options;
            ...
            _opened: function _opened(options) {
                if (!this.isOpen) {
                    return;
                }
            ...
            _closed: function _closed(options) {
                if (this.isOpen) {
                    return;
                }
                this.element.classList.remove(rb.statePrefix + 'open');
            ...
            _scroll: function _scroll(relPos, animationData) {
        ...
        /** @lends rb.components.panelbutton.prototype */
        {
             ...
             * </div>
             */
            init: function init(element, initialOpts) {
            ...
            associatePanel: function associatePanel() {
                var panelComponent;
