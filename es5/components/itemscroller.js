(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'babel-runtime/helpers/typeof', '../utils/rb_draggy', '../utils/rb_wheelanalyzer', '../utils/rb_resize', '../utils/rb_prefixed', '../utils/rb_debounce'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('babel-runtime/helpers/typeof'), require('../utils/rb_draggy'), require('../utils/rb_wheelanalyzer'), require('../utils/rb_resize'), require('../utils/rb_prefixed'), require('../utils/rb_debounce'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global._typeof, global.rb_draggy, global.rb_wheelanalyzer, global.rb_resize, global.rb_prefixed, global.rb_debounce);
    ...
    (function (factory) {
        ...
        /** @lends rb.components.itemscroller.prototype */
        {
            ...
            * });
            ...
            _generateHelper: function _generateHelper() {
            ...
            _mainSetup: function _mainSetup() {
                var that = this;
            ...
            _setupFocusScroll: function _setupFocusScroll() {
                var that = this;
             ...
             */
            _snapTo: function _snapTo(dir, velocity, length) {
                var pageIndex;
            ...
            getNearest: function getNearest() {
                var prop, curDiff;
            ...
            selectNearest: function selectNearest(noAnimate) {
                return this.selectIndex(this.getNearest(), noAnimate);
            },
            _getPosition: function _getPosition(index) {
             ...
             * @returns {number}
             */
            getNext: function getNext(offset) {
                var i, len, cellWidth;
             ...
             */
            selectNext: function selectNext(noAnimate) {
             ...
             * @returns {number}
             */
            getPrev: function getPrev(offset) {
                var cellWidth;
                var curPos = (this._pos + (offset || 0)) * -1 - 1;
                var index = 0;
             ...
             * @returns {Number|undefined}
             */
            selectPrev: function selectPrev(noAnimate) {
             ...
             * @returns {Number}
             */
            getPageIndexOfCell: function getPageIndexOfCell(cellIndex) {
             ...
             */
            selectCell: function selectCell(cellIndex, noAnimate) {
             ...
             */
            isCellVisible: function isCellVisible(cellIndex) {
            ...
            _slideProgress: function _slideProgress(tween, progress) {
                this._setPos((this._animEnd - this._animStart) * this.easing(progress) + this._animStart);
            },
            _slideComplete: function _slideComplete() {
             ...
             */
            selectPrevIndex: function selectPrevIndex() {
                var index = this._selectedIndex - 1 + this.baseIndex;
             ...
             * @returns {*|number}
             */
            selectIndex: function selectIndex(index, noAnimate) {
             ...
             * @returns {boolean}
             */
            isStartReached: function isStartReached(position) {
                if (position == null) {
                    position = this._pos;
                }
             ...
             * @returns {boolean}
             */
            isEndReached: function isEndReached(position) {
                if (position == null) {
                    position = this._pos;
                }
            ...
            _updateControls: function _updateControls(pos) {
                var isEnd, isStart;
            ...
            _dragMove: function _dragMove(draggy) {
                if (draggy.relPos.x) {
                    this._setRelPos(draggy.relPos.x * -1, true);
                }
            },
            _dragEnd: function _dragEnd(draggy) {
            ...
            _setupTouch: function _setupTouch() {
                if (!$.fn.draggy) {
                    return;
                }
            ...
            _setRelPos: function _setRelPos(relPos, keepInBounds) {
            ...
            _setOrder: function _setOrder(elem, order) {
                elem.style[orderProp] = order;
            },
            _changeWrap: function _changeWrap(side, prop) {
            ...
            _getCellWidth: function _getCellWidth(element) {
            ...
            _writeLayout: function _writeLayout() {
            ...
            _adjustSelectedIndex: function _adjustSelectedIndex() {
            ...
            _addPosCorrect: function _addPosCorrect(pageData, cells, pageCorrect, wrappedIndex) {
                var i, len, cell;
            ...
            _createCarouselPages: function _createCarouselPages() {
