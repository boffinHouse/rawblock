(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../utils/global-rb', '../utils/rafqueue', '../utils/get-styles', '../utils/get-css', '../utils/get-css-numbers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../utils/global-rb'), require('../utils/rafqueue'), require('../utils/get-styles'), require('../utils/get-css'), require('../utils/get-css-numbers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.globalRb, global.rafqueue, global.getStyles, global.getCss, global.getCssNumbers);
        global.$_dimensions = mod.exports;
    }
})(this, function (exports, _globalRb, _rafqueue, _getStyles, _getCss, _getCssNumbers) {
    'use strict';
                ...
                fn[fnName] = function (margin) {
                    ...
                    if (elem) {
                        if (elem.nodeType == 9) {
                            ...
                            ret = (0, _getCss2.default)(elem, cssName, true, styles);
