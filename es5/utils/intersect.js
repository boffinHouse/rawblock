(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './viewport'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./viewport'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.viewport);
    ...
    rb.intersects = function (element, margin, intersect) {
        ...
        return intersectValue && intersectValue[margin] && intersectValue[margin][intersect] ? intersectValue[margin][intersect].value : (0, _viewport2.default)(element, margin, intersect);
    };
                ...
                if (intersectValue[margin]) {
                    for (intersect in intersectValue[margin]) {
                        if (intersectObj = intersectValue[margin][intersect]) {
                            inViewport = (0, _viewport2.default)(element, intersectObj.margin, intersectObj.intersect);
        ...
        add: function add(element, fn, opts) {
            ...
            if (!intersectValue[margin][intersect]) {
                intersectValue[margin][intersect] = {
                    value: (0, _viewport2.default)(element, margin, intersect),
                    margin: margin,
                    intersect: intersect,
                    cbs: $.Callbacks()
                };
