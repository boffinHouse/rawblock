(function (global, factory) {
    ...
    (function (factory) {
        ...
        var getData = function getData(oReq, obj) {
            ...
            if ((0, _typeof3.default)(obj.data) != 'object' && (oReq.getResponseHeader('Content-Type') || '').split(';')[0].endsWith('json')) {
        ...
        *  });
        ...
        rb.fetch = function (url, options) {
            ...
            (function () {
                ...
                if (options.processData && data && $.param && (typeof data === 'undefined' ? 'undefined' : (0, _typeof3.default)(data)) == 'object') {
                    data = $.param(data);
