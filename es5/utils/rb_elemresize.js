(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        factory(mod.exports);
        global.rb_elemresize = mod.exports;
    }
    ...
    var elementResize = {
        add: function add(element, fn, options) {
            var that = void 0;
        ...
        remove: function remove(element, fn) {
            if (element[elementResize.expando]) {
        ...
        addMarkup: rb.rAF(function (element, data) {
            ...
            var scrollWrite = function scrollWrite() {
            ...
            wrapper.innerHTML = '<span style="' + wrapperStyle + 'overflow: scroll;-webkit-overflow-scrolling:auto;">' + '<span style="' + posStyle + '"></span>' + '</span>' + '<span style="' + wrapperStyle + 'overflow: scroll;-webkit-overflow-scrolling:auto;">' + '<span style="' + posStyle + 'width: 200%; height: 200%;"></span>' + '</span>';
    ...
    exports.default = $.fn.elementResize;
});
