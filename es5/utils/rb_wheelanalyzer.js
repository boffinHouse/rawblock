(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './rb_pubsub', './rb_debounce'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./rb_pubsub'), require('./rb_debounce'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.rb_pubsub, global.rb_debounce);
