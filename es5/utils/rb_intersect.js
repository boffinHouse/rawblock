(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'babel-runtime/helpers/typeof', './rb_viewport', './rb_layoutobserve'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('babel-runtime/helpers/typeof'), require('./rb_viewport'), require('./rb_layoutobserve'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global._typeof, global.rb_viewport, global.rb_layoutobserve);
