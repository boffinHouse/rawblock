(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './rafqueue', './add-log', './deferred'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./rafqueue'), require('./add-log'), require('./deferred'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.rafqueue, global.addLog, global.deferred);
        global.springAnimation = mod.exports;
    }
})(this, function (exports, _rafqueue, _addLog, _deferred) {
    'use strict';
    ...
    var SpringAnimation = function () {
        ...
        function SpringAnimation(options) {
            ...
            (0, _addLog2.default)(this, this.options.debug === 'inherit' ? rb.isDebug : this.options.debug);
            ...
            this.ended = false;
            this.promise = (0, _deferred2.default)();
        ...
        SpringAnimation.prototype.update = function update() {
            (0, _rafqueue2.default)(this._update, false, true);
        };
