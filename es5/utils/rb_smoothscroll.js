(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './rb_scrollintoview'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./rb_scrollintoview'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.rb_scrollintoview);
        global.rb_smoothscroll = mod.exports;
    }
